...
const validationVoteSchema = new Schema({
    userId: { type: Schema.Types.ObjectId, ref: 'User', required: true },
...
const livePollSchema = new Schema({
    ...
    options: {
        ...
        required: true,
        validate: [
            (v) => Array.isArray(v) && v.length >= 2 && v.length <= 8,
...
export const LiveRoom = mongoose.models.LiveRoom ??
    mongoose.model('LiveRoom', liveRoomSchema);
//# sourceMappingURL=LiveRoom.model.js.map