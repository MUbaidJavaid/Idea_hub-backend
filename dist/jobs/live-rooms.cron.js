...
import { notifyLiveRoomRsvpReminder, roomsNeedingRsvpReminder, } from '../services/live-rooms.service.js';
cron.schedule('*/2 * * * *', async () => {
    ...
    try {
        ...
        for (const room of due) {
            ...
            await LiveRoom.updateOne({ _id: room._id }, { $set: { rsvpReminderSentAt: new Date() } });
        }
        if (due.length > 0) {
...
//# sourceMappingURL=live-rooms.cron.js.map