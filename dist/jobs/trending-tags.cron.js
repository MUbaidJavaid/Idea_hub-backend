...
async function refreshTrendingTags() {
    ...
    await TrendingTagsSnapshot.findByIdAndUpdate(TRENDING_TAGS_DOC_ID, { $set: { tags, updatedAt: new Date() } }, { upsert: true, new: true }).catch((err) => {
...
//# sourceMappingURL=trending-tags.cron.js.map