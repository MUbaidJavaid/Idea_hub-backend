...
import { diffIdeaVersions, ensurePublishedIdeaHasVersionHistory, loadIdeaVersionLean, } from '../../lib/idea-versioning.js';
import { optionalAuth } from '../../middleware/optional-auth.js';
import { Idea, IdeaVersion } from '../../models/index.js';
import { requireDb } from './guards.js';
export function registerVersionRoutes(ideasRouter) {
    ...
    ideasRouter.get('/:id/versions/diff', requireDb, optionalAuth, async (req, res) => {
        const { id } = req.params;
...
//# sourceMappingURL=register-version-routes.js.map