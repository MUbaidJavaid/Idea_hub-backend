...
import { CloudinaryConfigError, uploadToCloudinary, } from '../services/cloudinary.service.js';
const log = logger.child({ module: 'upload' });
function uploadRouteErrorMessage(e) {
...
uploadRouter.post('/', requireDb, requireAuth, parseSingleFile, async (req, res) => {
